...
static sem_t mutex, full[30], empty;
...
int main(int argc, char *argv[])
{
    ...
    space = (char**)malloc(sizeof(char*)*number_of_buffer);
    for (i = 0; i < number_of_buffer; ++i)
    {
    ...
    int count[number_of_buffer],situation[number_of_buffer];
    for (i = 0; i < number_of_buffer; ++i)
    {
        count[i] = 0;
        situation[i] = 0;
    ...
    pthread_create(&producer, NULL, mapper, NULL);
    for (i = 0; i < number_of_buffer; i++) {
